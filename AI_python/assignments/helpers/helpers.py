...
#Run code
def callpythoncode(code, cmdline_args=[], input='', timeout=3600):
    path=getpath()
...
def callpythonmaincode(code, cmdline_args=[], input='', timeout=3600):
    my_code=loadmycode()
...
#Run my_code.py
def callpython(cmdline_args=[], input='', timeout=3600):
    path=getpath()
...
def callpython_subprocess(cmdline_args=[], input='', timeout=3600):
...
def callCS(cmdline_args=[], input='', timeout=3600):
    path=getpath()
...
def callCSFunction(cmdline_args=[], input='', timeout=3600):
    path=getpath()
...
def callC(cmdline_args=[], input='', timeout=3600):
    path=getpath()
...
def callCFunction(cmdline_args=[], input='', timeout=3600):
    path=getpath()
